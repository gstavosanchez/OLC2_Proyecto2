...
var t291, t292, t293, t294, t295, t296 float64
...
L41:
	t227 = P + 1 //Posicionar el puntero
	t226 = stack[int(t227)]
	if t226 > t221 {
		goto L42
	}
	...
	// -----------------------------------------------------------
	// ACCESO A VARIABLE: X
	t229 = P + 1 //Posicionar el puntero
	t228 = stack[int(t229)]
	// FIN ACCESO
	// -----------------------------------------------------------
	...
	// -----------------------------------------------------------
	// ACCESO A VARIABLE: X
	t236 = P + 1 //Posicionar el puntero
	t235 = stack[int(t236)]
	// FIN ACCESO
	// -----------------------------------------------------------
...
L43:
	t245 = P + 1 //Posicionar el puntero
	t244 = stack[int(t245)]
	t244 = t244 + 1
	stack[int(t245)] = t244
	goto L41
...
L48:
	t275 = P + 1 //Posicionar el puntero
	t274 = stack[int(t275)]
	if t274 > t269 {
		goto L49
	}
	...
	// -----------------------------------------------------------
	// ACCESO A VARIABLE: Y
	t277 = P + 1 //Posicionar el puntero
	t276 = stack[int(t277)]
	// FIN ACCESO
	// -----------------------------------------------------------
	...
	// -----------------------------------------------------------
	// ACCESO A VARIABLE: Y
	t284 = P + 1 //Posicionar el puntero
	t283 = stack[int(t284)]
	// FIN ACCESO
	// -----------------------------------------------------------
...
L50:
	t293 = P + 1 //Posicionar el puntero
	t292 = stack[int(t293)]
	t292 = t292 + 1
	stack[int(t293)] = t292
	goto L48
