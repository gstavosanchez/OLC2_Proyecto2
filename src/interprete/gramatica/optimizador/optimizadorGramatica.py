from src.interprete.optimizador.instrucciones.Function import Function
from src.interprete.optimizador.instrucciones.Return import Return
from src.interprete.optimizador.Optimizador import Optimizador
from src.interprete.optimizador.expresiones.Access import Access
from src.interprete.optimizador.expresiones.Expression import Expression
...
from src.interprete.optimizador.instrucciones.CallFun import CallFun
from src.interprete.optimizador.instrucciones.Label import Label
from src.interprete.optimizador.instrucciones.Printf import Printf
...
def p_print(t):
    ...
    t[0] = Printf(t[5], t[7], t.lineno(1), t.lexpos(1))
